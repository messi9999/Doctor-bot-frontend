...
export default function Options() {
  ...
  return (
    <div className="bg-white mx-3 wrapper" style={{ height: "90vh" }}>
      <div className="row">
        <div className="title">
          <MedicalInformationIcon color="primary" /> Medical Information
        </div>
        <p className="p1">
          provide your medical information for more personalized and informative
          suggestions.
        </p>
        <div className="row">
      ...
      <div className="row">
        <div className="title">
          <FilterTiltShiftRoundedIcon color="primary" /> Core
        </div>
      ...
      <div className="row">
        <div className="title">
          <MonitorHeartIcon color="primary" /> Patients body stats
        </div>
        <div className="row spc">
          <div className="col-6 ">
