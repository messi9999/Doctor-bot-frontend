...
import { ReactComponent as EditIcon } from "../assets/images/icons8-edit.svg";
import { ReactComponent as DeleteIcon } from "../assets/images/icons8-delete.svg";
...
export default function Adminboard() {
  ...
  return (
    <div className="home-main bg-white mb-0 bg-gradient py-3">
